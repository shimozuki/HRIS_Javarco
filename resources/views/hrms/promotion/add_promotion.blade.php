                                ...
                                <div class="table-responsive">
                                    <div class="panel-body p25 pb10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <select class="select2-single form-control select-primary" name="emp_id" id="pegawai" required>
                                                    <option value="" selected>Select One</option>
                                                    @foreach($emps as $emp)
                                                    <option value="{{$emp->id}}" data-price="{{$emp->salary}}" data-role="{{$emp->jabatan}}">{{$emp->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" id="datepicker1" class="select2-single form-control" name="date_of_promotion" required>
                                                </div>
                                            </div>
                                        </div>
...
<script src="/assets/js/pages/custome.js"></script>
<script>
    $('#pegawai').on('change', function() {
        const gaji = $('#pegawai option:selected').data('price');
        const jabatan = $('#pegawai option:selected').data('role');

        $('[name=old_designation]').val(jabatan);
        $('[name=old_salary]').val(gaji);
    });
</script>
@endpush